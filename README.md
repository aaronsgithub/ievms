...
Just paste this into a terminal: 
    ...
    curl -s https://raw.githubusercontent.com/aaronsgithub/ievms/master/ievms.sh | bash
...
**2.)** Download and unpack ievms:
   ...
   * To install specific IE versions (IE7 and IE9 only for example) use:
        ...
        curl -s https://raw.githubusercontent.com/aaronsgithub/ievms/master/ievms.sh | env IEVMS_VERSIONS="7 9" bash
...
To specify where the VMs are installed, use the `INSTALL_PATH` variable:
    ...
    curl -s https://raw.githubusercontent.com/aaronsgithub/ievms/master/ievms.sh | env INSTALL_PATH="/Path/to/.ievms" bash
...
environment variable. For example, you can set a download speed limit:
    ...
    curl -s https://raw.githubusercontent.com/aaronsgithub/ievms/master/ievms.sh | env CURL_OPTS="--limit-rate 50k" bash
...
environment variable `REUSE_XP` to anything other than `yes`:
    ...
    curl -s https://raw.githubusercontent.com/aaronsgithub/ievms/master/ievms.sh | env REUSE_XP="no" bash
...
variable `REUSE_WIN7` to anything other than `yes`:
    ...
    curl -s https://raw.githubusercontent.com/aaronsgithub/ievms/master/ievms.sh | REUSE_WIN7="no" bash
